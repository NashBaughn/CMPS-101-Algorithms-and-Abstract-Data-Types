...
//cruzId: nbaughn
/* intVec.h
* This header file is needed to be able to use the functions and defintnions from intVec.c in loadGraph.c.
* In other words, loadGraph.c has access to intVec.c though intVec.h (header file).
*/
...
/** intTop()
 * precondition: myVec had been constructed
 * precondition: myVec->sz > 0
 */
